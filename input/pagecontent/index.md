...
In addition, material was drawn from the [US Core Implementation Guide](http://hl7.org/fhir/uv/core/) and the [Genomics Reporting Implementation Guide](http://hl7.org/fhir/uv/genomics-reporting/).
