...
* When information in the scenario does not map on to mCODE profiles, we provide examples using standard FHIR resources.
...
| [`Clinical Cancer Stage Group: 2B`](Observation-tnm-clinical-stage-group-jenny-m.html) |[TNMStageGroup] |
