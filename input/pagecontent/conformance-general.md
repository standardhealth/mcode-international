...
* Disease
  * Diagnosis
    ...
    * [PrimaryCancerCondition]\: `GET [base]/Condition?code:in=http://hl7.org/fhir/uv/mcode/ValueSet/mcode-primary-or-uncertain-behavior-cancer-disorder-vs` (alternate form)
    * [SecondaryCancerCondition]\: `GET [base]/Condition?category=http://snomed.info/sct|128462008` (preferred form)
    * [SecondaryCancerCondition]\: `GET [base]/Condition?code:in=http://hl7.org/fhir/uv/mcode/ValueSet/CancerStagingTypeVS` (alternate form)
  * Staging
    ...
    * [CancerStageGroup]\: `GET [base]/Observation?code:in=http://hl7.org/fhir/uv/mcode/ValueSet/mcode-cancer-staging-type-vs` (alternate form)
  * Characterization
    * [TumorMarkerTest]\: `GET [base]/Observation?category=http://snomed.info/sct|250724005` (preferred form)
    * [TumorMarkerTest]\: `GET [base]/Observation?code:in=http://hl7.org/fhir/uv/mcode/ValueSet/mcode-tumor-marker-test-vs` (alternate form)
