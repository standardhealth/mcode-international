...
* format[1] = #json
* fhirVersion = #4.0.1
* implementationGuide = "http://hl7.org/fhir/uv/mcode/ImplementationGuide/hl7.fhir.uv.mcode"
* rest[0].mode = #server
...
* imports = "http://hl7.org/fhir/uv/core/CapabilityStatement/us-core-server"   // Import the US Core Server Capability Statement
...
* rest[0].resource[0].supportedProfile[0] = "http://hl7.org/fhir/uv/mcode/StructureDefinition/mcode-cancer-patient"
...
* rest[0].resource[=].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest[0].resource[=].extension.valueCode = #SHALL
* rest[0].resource[1].supportedProfile[0] = "http://hl7.org/fhir/uv/mcode/StructureDefinition/mcode-cancer-patient"
* rest[0].resource[0].supportedProfile[0].extension.valueCode = #SHALL
...
* rest[0].resource[1].searchParam[0].definition = "http://hl7.org/fhir/uv/mcode/SearchParameter/Condition-code"
