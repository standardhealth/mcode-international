...
* insert BundleSlice(therapeuticImplications, 0, *, Genomic Therapeutic Implications, Profile with properties for observations that convey the potential impact of genomic characteristics on a medication or non-medicinal therapy., http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/therapeutic-implication)
...
* insert BundleSlice(tumorMutationBurden, 0, *, Tumor Mutation Burden, The total number of mutations or changes found in the DNA of cancer cells., http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/tmb)
...
* insert BundleSlice(vitalSigns, 0, *, Vital Signs, Observation resources representing patient height\, weight\, blood pressure\, and other vital signs., VitalSigns)
*/
